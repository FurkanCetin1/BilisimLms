...
namespace BilisimLms.Web {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/DevExpressExpressAppWebWebApplicationMembersTopicAll.aspx
    public partial class BilisimLmsAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private BilisimLms.Module.BilisimLmsModule module3;
        private BilisimLms.Module.Web.BilisimLmsAspNetModule module4;
        ...
        static BilisimLmsAspNetApplication() {
        ...
        #endregion
        public BilisimLmsAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void BilisimLmsAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new BilisimLms.Module.Web.BilisimLmsAspNetModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.BilisimLmsAspNetApplication_DatabaseVersionMismatch);
