...
namespace BilisimLms.Mobile {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/DevExpressExpressAppWebWebApplicationMembersTopicAll.aspx
    public partial class BilisimLmsMobileApplication : MobileApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Mobile.SystemModule.SystemMobileModule module2;
        private BilisimLms.Module.BilisimLmsModule module3;
        private BilisimLms.Module.Mobile.BilisimLmsMobileModule module4;
        ...
        static BilisimLmsMobileApplication() {
        ...
        #endregion
        public BilisimLmsMobileApplication() {
        ...
        private void BilisimLmsMobileApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new BilisimLms.Module.BilisimLmsModule();
            this.module4 = new BilisimLms.Module.Mobile.BilisimLmsMobileModule();
            ...
            // 
            // BilisimLmsMobileApplication
            // 
            this.ApplicationName = "BilisimLms";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.BilisimLmsMobileApplication_DatabaseVersionMismatch);
